...
def obtener_conceptos_python_avanzado():
    ...
    conceptos.append(ConceptoAnclado(
        id="CONCEPTO_FILTER",
        tipo=TipoConcepto.OPERACION_SISTEMA,
        palabras_español=["filter", "filtrar"],
        confianza_grounding=0.9,
        propiedades={
            'es_funcion_orden_superior': True,
    ...
    conceptos.append(ConceptoAnclado(
        id="CONCEPTO_EXCEPT",
        tipo=TipoConcepto.CONCEPTO_ABSTRACTO,
        palabras_español=["except", "exception"],
        confianza_grounding=0.9,
        propiedades={
            'captura_error': True,
            'requiere_try': True
    ...
    conceptos.append(ConceptoAnclado(
        ...
        tipo=TipoConcepto.CONCEPTO_ABSTRACTO,
        palabras_español=["exception", "error"],
        confianza_grounding=0.8,
        propiedades={
            'es_clase': True,
    ...
    conceptos.append(ConceptoAnclado(
        id="CONCEPTO_MODULE",
        tipo=TipoConcepto.CONCEPTO_ABSTRACTO,
        palabras_español=["module", "módulo"],
        confianza_grounding=0.8,
        propiedades={
            'es_archivo_py': True,
            'agrupa_codigo': True
    ...
    conceptos.append(ConceptoAnclado(
        id="CONCEPTO_AS",
        tipo=TipoConcepto.CONCEPTO_ABSTRACTO,
        palabras_español=["as", "como", "alias"],
        confianza_grounding=0.9,
        propiedades={
            'crea_alias': True
        }
